...
public class StackMachine {
    ...
    private void binaryOp(String value) {
        switch (value) {
            ...
            case "type":
                ...
                switch (buff) {
                    case "List":
                        variablesTable.put(stackMachine.pop().getValue(), new Variable(buff, new MyLList()));
                        break;
                    case "HashSet":
    ...
    private void printList(MyLList list, String varName) {
